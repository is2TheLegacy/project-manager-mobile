...
import py.fpuna.is2.proyectos.alpha.business.services.usuarios.UsuarioService;
...
public class UserAuthorizator {
    ...
    public void setRegistrationId(UUID token, String gcmRegistrationId) {
        TokenAutorizacion currentToken
                = authorizationTokensStorage.find(token);
        if(currentToken != null) {
            currentToken.setGcmRegistrationId(gcmRegistrationId);
        }
