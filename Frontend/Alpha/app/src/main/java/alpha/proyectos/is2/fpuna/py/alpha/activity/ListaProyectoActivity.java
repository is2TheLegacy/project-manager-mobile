 ...
 */
public class ListaProyectoActivity extends BaseActivity implements Callback<List<Tarea>> {
    ...
    protected void inint() {
        ...
        agregarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(ListaProyectoActivity.this, CrearTareaActivity.class);
                startActivity(i);
            }
        });
